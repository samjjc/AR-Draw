...
(private val context: Context) : DisplayManager.DisplayListener {
     ...
     * [  #onSurfaceChanged(javax.microedition.khronos.opengles.GL10, int, int)][android.opengl.GLSurfaceView.Renderer].
     *
     ...
     * [.onSurfaceChanged] call or by [.onDisplayChanged] system
     * callback. This function should be called explicitly before each call to
     * [Session.update]. This function will also clear the 'pending update'
