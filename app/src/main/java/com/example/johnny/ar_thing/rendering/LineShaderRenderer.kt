...
class LineShaderRenderer {
    ...
    private var mPositionAddress: Int = 0
    private var mPreviousAddress: Int = 0
    private var mNextAddress: Int = 0
    private var mSideAddress: Int = 0
    private var mWidthAddress: Int = 0
    private var mCounterAddress: Int = 0
    ...
    private var mColor: Vector3f = Vector3f(255f, 255f, 255f)
    ...
    fun createOnGlThread(context: Context) {
         ...
         * line_frag.shader.glsl shader to render a volumetric line.  It uses several techniques detailed in
     ...
     * @param side
     */
    private fun setMemory(index: Int, pos: Vector3f, prev: Vector3f, next: Vector3f, counter: Float, width: Float, side: Float) {
     ...
     * @param farClip
     */
    fun draw(cameraView: FloatArray, cameraPerspective: FloatArray, screenWidth: Float, screenHeight: Float, nearClip: Float, farClip: Float) {
